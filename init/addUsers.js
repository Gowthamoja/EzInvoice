...
const seedInvoices = async () => {
    try {
        ...
        if (users.length < 6) {
            console.log("Please run seedUsers.js first with your specific users!");
            return;
        }
        ...
        users.forEach((user) => {
            ...
            data.clients.forEach((client, i) => {
                ...
                // Fixes your phone regex (10 digits starting with 6-9)
                ...
                allInvoices.push({
                    ...
                    // TAKING THE EXACT DATA FROM YOUR USER OBJECT
                    billFrom: {
        ...
        console.log(`Success! Seeded 30 professional invoices using your exact user data.`);
